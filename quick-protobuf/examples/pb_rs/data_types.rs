...
impl<'a> MessageWrite for FooMessage<'a> {
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        self.f_int32.as_ref().map_or(Ok(()), |&m| w.write_with_tag(8, |w| w.write_int32(*&m)))?;
        self.f_int64.as_ref().map_or(Ok(()), |&m| w.write_with_tag(16, |w| w.write_int64(*&m)))?;
        self.f_uint32.as_ref().map_or(Ok(()), |&m| w.write_with_tag(24, |w| w.write_uint32(*&m)))?;
        self.f_uint64.as_ref().map_or(Ok(()), |&m| w.write_with_tag(32, |w| w.write_uint64(*&m)))?;
        self.f_sint32.as_ref().map_or(Ok(()), |&m| w.write_with_tag(40, |w| w.write_sint32(*&m)))?;
        self.f_sint64.as_ref().map_or(Ok(()), |&m| w.write_with_tag(48, |w| w.write_sint64(*&m)))?;
        self.f_bool.as_ref().map_or(Ok(()), |&m| w.write_with_tag(56, |w| w.write_bool(*&m)))?;
        self.f_FooEnum.as_ref().map_or(Ok(()), |&m| w.write_with_tag(64, |w| w.write_enum(m as i32)))?;
        self.f_fixed64.as_ref().map_or(Ok(()), |&m| w.write_with_tag(73, |w| w.write_fixed64(*&m)))?;
        self.f_sfixed64.as_ref().map_or(Ok(()), |&m| w.write_with_tag(81, |w| w.write_sfixed64(*&m)))?;
        self.f_fixed32.as_ref().map_or(Ok(()), |&m| w.write_with_tag(93, |w| w.write_fixed32(*&m)))?;
        self.f_sfixed32.as_ref().map_or(Ok(()), |&m| w.write_with_tag(101, |w| w.write_sfixed32(*&m)))?;
        self.f_double.as_ref().map_or(Ok(()), |&m| w.write_with_tag(105, |w| w.write_double(*&m)))?;
        self.f_float.as_ref().map_or(Ok(()), |&m| w.write_with_tag(117, |w| w.write_float(*&m)))?;
        self.f_bytes.as_ref().map_or(Ok(()), |m| w.write_with_tag(122, |w| w.write_bytes(&m)))?;
        self.f_string.as_ref().map_or(Ok(()), |m| w.write_with_tag(130, |w| w.write_string(&m)))?;
        self.f_self_message.as_ref().map_or(Ok(()), |m| w.write_with_tag(138, |w| w.write_message(&*(*(m)))))?;
        self.f_bar_message.as_ref().map_or(Ok(()), |m| w.write_with_tag(146, |w| w.write_message(m)))?;
        ...
        self.f_imported.as_ref().map_or(Ok(()), |m| w.write_with_tag(178, |w| w.write_message(m)))?;
        self.f_baz.as_ref().map_or(Ok(()), |m| w.write_with_tag(186, |w| w.write_message(m)))?;
        self.f_nested.as_ref().map_or(Ok(()), |m| w.write_with_tag(194, |w| w.write_message(m)))?;
        self.f_nested_enum.as_ref().map_or(Ok(()), |&m| w.write_with_tag(200, |w| w.write_enum(m as i32)))?;
...
impl MessageWrite for BazMessage {
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        self.nested.as_ref().map_or(Ok(()), |m| w.write_with_tag(10, |w| w.write_message(m)))?;
        Ok(())
    }
}
